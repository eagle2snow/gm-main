...
<body class="hold-transition skin-blue sidebar-mini">
										...
										<tbody>
											...
											<c:forEach items="${page.list}" var="model">
												<tr>
													...
													<th>${model.shi}室${model.ting}厅${model.wei}卫</th>
													<th><c:choose>
													...
													<td class="td-status">
														<div class="switch switchevent" data-on="primary" lang="${model.id}"
															title="${model.enable}" data-on-label="是" data-off-label="否" data-off="info">
	...
	<script>
		...
		function goxq(id){
			openPerRe("二手房详情", 90,90,'${adp}show/'+id+'.htm');
		}
		
		function edit(id){
		
				openPerRe("编辑二手房", 90,90,'${adp}update/'+id+'.htm');
		...
		function gocomment(id){
			openPerRe("二手房  / 点评列表", 90,90,'${adp}showComment/'+id+'.htm');
		}
