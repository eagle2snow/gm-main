					...
					<div class="box box-info">
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" placeholder="版本号" id="version" name="version" />
								</div>
							</div>
						</div>
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" placeholder="版本索引" id="versionIndex"
										name="versionIndex" />
								</div>
							</div>
						</div>
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<label><input value="1" type="radio" class="minimal" name="type">用户版</label> <label><input
										value="2" type="radio" class="minimal" name="type">商家版</label>
								</div>
							</div>
						</div>
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<label><input value="1" type="radio" class="minimal" name="platform">安卓</label> <label><input
										value="2" type="radio" class="minimal" name="platform">苹果</label>
								</div>
							</div>
						</div>
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<label><input value="1" type="radio" class="minimal" name="typeApp">wgt</label> <label><input
										value="2" type="radio" class="minimal" name="typeApp">apk</label>
								</div>
							</div>
						</div>
