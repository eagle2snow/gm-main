...
<body>
					...
					<div class="box-header with-border">
						<h3 class="box-title">编辑</h3>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" value="${model.version}"
							        placeholder="版本号" id="version" name="version"           />
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-2 control-label">版本索引:</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" value="${model.versionIndex}"
							        placeholder="版本索引" id="versionIndex" name="versionIndex"           />
								</div>
							</div>
								...
								<div class="form-group">
										...
										<div id="uploader0" class="wu-example">
											...
											<div class="thelist uploader-list">
												<div id="WU_FILE_0" class="item">
													<input name="url" id="WU_FILE_0_input" value="" type="hidden">
													<h4 class="info">${model.url}<i class="glyphicon glyphicon-remove-circle"></i></h4>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<label><input value="1"  ${model.type==1?'checked':'' }  type="radio" class="minimal" name="type">用户版</label>
											<label><input value="2"  ${model.type==2?'checked':'' }  type="radio" class="minimal" name="type">商家版</label>
										</div>
								</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<label><input value="1"  ${model.platform==1?'checked':'' }  type="radio" class="minimal" name="platform">安卓</label>
											<label><input value="2"  ${model.platform==2?'checked':'' }  type="radio" class="minimal" name="platform">苹果</label>
										</div>
								</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<label><input value="1"  ${model.typeApp==1?'checked':'' }  type="radio" class="minimal" name="typeApp">wgt</label>
											<label><input value="2"  ${model.typeApp==2?'checked':'' }  type="radio" class="minimal" name="typeApp">apk</label>
										</div>
								</div>
	...
	<script>
		...
		uploader0.on('fileQueued', function(file) {
			$list0.append('<div id="' + file.id + '" class="item">' +
				'<input name="url" id="'+file.id+'_input" type="hidden" value="${model.url}" />'+
