				...
				<form action="" method="post" id="form">
					<div class="panel loginbox">
						...
						<div class="panel-body" style="padding: 30px; padding-bottom: 10px; padding-top: 10px;">
							...
							<div class="form-group">
								<div class="field field-icon-right">
									<input type="password" class="input input-big" name="password"
										id="password" value="admin" placeholder="登录密码"
							...
							<img style="margin-left: 70px" src="data:image/png;base64,${qrString }" width="200"
								height="200">

							<p id="tip" style="text-align: center; font-size: 16px; margin-top: 10px;">
								<span style="color: red;">温馨提示：请用爱家app扫码登录</span>
							</p>
						</div>
