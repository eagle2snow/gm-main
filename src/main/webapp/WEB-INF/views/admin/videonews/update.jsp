...
<body>
	<section class="content">
		<form class="form-horizontal" method="post" id="form-admin-add" action="${adp}update.json">
			<input type="hidden" name="id" value="${model.id}" /> <input type="hidden" name="user.id"
				value="${model.user.id}" />
			<div class="row">
				<div class="col-md-12">
					...
					<div class="box box-info">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" value="${model.hit}" placeholder="播放次数" id="hit"
									name="hit" />
							</div>
						</div>
								...
								<div id="uploader0" class="wu-example">
									...
									<div class="thelist uploader-list">
										<div id="WU_FILE_0" class="item">
											<input name="url" id="WU_FILE_0_input" value="${model.url}" type="hidden">
											<h4 class="info">${model.url}<i class="glyphicon glyphicon-remove-circle"></i>
											</h4>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" value="${model.src}" placeholder="来源" id="src"
									name="src" />
							</div>
						</div>
