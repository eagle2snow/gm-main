				...
				<div class="col-md-12">
					...
					<div class="box box-info">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<label><input value="1" ${model.type==1?'checked':'' } type="radio" class="minimal"
									name="type">站内</label> <label><input value="2" ${model.type==2?'checked':'' }
									type="radio" class="minimal" name="type">站外</label>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" value="${model.src}" placeholder="广告链接" id="src"
									name="src" />
							</div>
						</div>
