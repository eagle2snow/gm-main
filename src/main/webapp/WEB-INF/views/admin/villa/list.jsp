...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
									...
									<tbody>
										...
										<tr>
											...
											<td>${model.id}</td>
											 ...
											 <th>${model.unitPrice}</th>
											
											 <th>${model.price}</th>
											
											<th class="text-center"><img src='${model.pic}' style="width: 50pxp; height: 50px;" /></th>
		...
		function edit(id){
				...
				openPerRe("编辑别墅", 90,90,'${adp}update/'+id+'.htm');
