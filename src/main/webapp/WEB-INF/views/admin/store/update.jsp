					...
					<div class="box-header with-border">
						<h3 class="box-title">编辑</h3>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" value="${model.tel}"
							        placeholder="电话" id="tel" name="tel"           />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<select name="admin.id" style="width: 100% !important;" class="form-control select2" id="admin">
												<c:forEach items="${adminList}" var="m">
													<option    ${model.admin.id==m.id?'selected':'' }  value="${m.id}">
														${m.name}
													</option>
												</c:forEach> 
											</select>
