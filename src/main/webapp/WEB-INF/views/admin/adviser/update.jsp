				...
				<div class="col-md-12">
					...
					<div class="box box-info">
						<div class="box-header with-border">
							<h3 class="box-title">修改销售顾问信息</h3>
						</div>
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-8">
									...
									<input class="file" type="file" id='avatar'> <input value="${model.avatar}"
										name="avatar" id="avatar_input" type="hidden" />
									<div style="overflow: hidden;" class="avatar">

										<div class="showimg-box pull-left">
											<div class="showimg">
												<img src="${model.avatar}" width="80" height="60" onclick="adminShowPic(this)">
											</div>
											<span onclick="delPic(this,avatar)" class="fa fa-close delete"></span>
										</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" value="${model.mobile}" placeholder="手机" id="mobile"
									name="mobile" />
							</div>
						</div>
						...
						<div class="form-group">
							<label class="col-sm-2 control-label">顾问介绍:</label>
							<div class="col-sm-8">
