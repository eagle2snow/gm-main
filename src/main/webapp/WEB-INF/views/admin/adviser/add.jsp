					...
					<div class="box box-info">
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-8">
									...
									<input class="file" type="file" id='avatar'> <input name="avatar" id="avatar_input"
										type="hidden" />
									<div style="overflow: hidden;" class="avatar"></div>
								</div>
							</div>
						</div>
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" placeholder="手机" id="mobile" name="mobile" />
								</div>
							</div>
						</div>
