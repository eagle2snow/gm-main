...
<body class="hold-transition skin-blue sidebar-mini">
									...
									<div class="row">
										...
										<div class="col-sm-6">
											<div id="example1_filter" class="dataTables_filter">
												<div class="text-c">
													<input type="text" name="" id="key" placeholder="姓名，手机，楼盘等"
										...
										<tbody>
											...
											<c:forEach items="${page.list}" var="model">
												<tr>
													...
													<th class="text-center"><img src='${model.avatar}'
	...
	<script>
		...
		function edit(id){
				...
				openPerRe("编辑销售顾问", 90,90,'${adp}update/'+id+'.htm');
