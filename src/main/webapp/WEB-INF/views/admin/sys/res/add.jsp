					...
					<div class="box box-info">
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" placeholder="权限码" id="code" name="code" />
								</div>
							</div>
						</div>
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<label><input value="1" type="radio" class="minimal" name="type">菜单</label> <label><input
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" placeholder="路径" id="url" name="url" />
								</div>
							</div>
						</div>
