...
<body>
	<section class="content">
		<form class="form-horizontal" method="post" id="form-admin-add"
			...
			<input disabled="disabled" type="hidden" name="id"
				value="${model.id}" />
			<div class="row">
				<div class="col-md-12">
					...
					<div class="box box-info">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input disabled="disabled" type="text" class="form-control"
									value="${model.area}" placeholder="请输入整数" id="area"
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input disabled="disabled" type="text" class="form-control"
									value="${model.price}" placeholder="月租" id="price" name="price" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input disabled="disabled" type="text" class="form-control"
									value="${model.ya}" placeholder="押" id="ya" name="ya" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input disabled="disabled" type="text" class="form-control"
									value="${model.fu}" placeholder="付" id="fu" name="fu" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input disabled="disabled" type="text" class="form-control"
									value="${model.mixMonth}" placeholder="起租月数" id="mixMonth"
									name="mixMonth" />
							</div>
						</div>
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" value="${model.lifts }"
										disabled="disabled" />
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input disabled="disabled" type="text" class="form-control"
									value="${model.owner}" placeholder="房东姓名" id="owner"
									name="owner" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input disabled="disabled" type="text" class="form-control"
									value="${model.ownerTel}" placeholder="房东电话" id="ownerTel"
									name="ownerTel" />
							</div>
						</div>
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<div id="notice" name="notice" class="form-control b0" rows="3"
										placeholder="请输入房源公告">${model.notice }</div>
								</div>
							</div>
						</div>
