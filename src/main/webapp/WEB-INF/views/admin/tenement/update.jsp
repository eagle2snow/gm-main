				...
				<div class="col-md-12">
					...
					<div class="box box-info">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" value="${model.area}" placeholder="请输入整数" id="area"
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" value="${model.price}" placeholder="月租" id="price"
									name="price" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" value="${model.ya}" placeholder="押" id="ya"
									datatype="n" name="ya" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" value="${model.fu}" placeholder="付" id="fu"
									datatype="n" name="fu" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" value="${model.mixMonth}" placeholder="起租月数"
									datatype="n" id="mixMonth" name="mixMonth" />
							</div>
						</div>
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" placeholder="几梯几户" id="lifts"
										value="${model.lifts }" name="lifts" />
								</div>
							</div>
						</div>
