					...
					<div class="box box-info">
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" placeholder="房屋面积" id="area" name="area" />
								</div>
							</div>
						</div>
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" placeholder="请填写数字" datatype="n" id="price"
										name="price" />
								</div>
							</div>
						</div>
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" placeholder="请填写数字" datatype="n" id="ya" name="ya" />
								</div>
							</div>
						</div>
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" placeholder="床位数" id="bed" name="bed" />
								</div>
							</div>
						</div>
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" placeholder="起租天数" id="mixDay" name="mixDay" />
								</div>
							</div>
						</div>
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" placeholder="房东姓名" id="owner" name="owner" />
								</div>
							</div>
						</div>
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" placeholder="房东电话" id="ownerTel" name="ownerTel" />
								</div>
							</div>
						</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<label><input value="1" checked="checked" type="radio" class="minimal"
										name="status">待出租</label> <label><input value="2" type="radio" class="minimal"
										name="status">已租出</label>
								</div>
							</div>
						</div>
