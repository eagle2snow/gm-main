...
public class AdminNewsController extends BaseAdminController {

	private final static String path = "admin/news/";
	...
	public String addView(ModelMap map) {
		...
		map.put("path", path);
		map.put("newsCatList", newsCatService.list());
		return path + "add";
	}
	...
	public Map<String, Object> addAction(News model) {
		Map<String, Object> map = new HashMap<>();

	/*	String pic = HtmlUtil.getImgSrc(model.getContent());
		model.setPic(pic);*/
	...
	@ResponseBody
	public Map<String, Object> updateAction(News model) {
		Map<String, Object> map = new HashMap<>();
	/*	String pic = HtmlUtil.getImgSrc(model.getContent());
		model.setPic(pic);*/
	...
	@RequiresPermissions("admin:news:show")
	...
	public String manager(ModelMap map, @PathVariable Integer pageIndex, @PathVariable Integer pageSize, String k) {
		...
		Page<News> list = newsService.list(dc, pageIndex, pageSize);
		map.put("page", list);
		map.put("path", path);
		map.put("key", k);
		return path + "list";
	...
	public Map<String, Object> delete(@PathVariable Integer id) {
		Map<String, Object> map = new HashMap<>();
		if (newsService.deleteById(id, false)) {
			map.put("status", "ok");
		} else {
			map.put("status", "no");
		}
	...
	public Map<String, Object> delete(@PathVariable String ids) {
		...
		if (newsService.deleteByIds(arrayId, false)) {
			map.put("status", "ok");
		} else {
			map.put("status", "no");
		}
